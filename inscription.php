...
function adduser($prenom, $email,$password,$telephone,$adresse){
    $sql = "INSERT INTO `user` (`id`,`prenom`, `email`, password, `telephone`,`adresse`) VALUES (NULL,'$prenom', '$email','$password', '$telephone', '$adresse');";
    ...
    if (isset($_POST['prenom'])){
        ...
        adduser($prenom, $email,$password, $telephone,$adresse);
...
<body>
	<div class="box">
		...
		<form  method="POST" action="">
			<div class="inBox">
				<input type="text" name="prenom" required="" placeholder="Prénom et nom">
			</div>
			<div class="inBox">
            ...
            <div class="inBox">
				<input type="text" name="telephone" required="" placeholder="Téléphone" value="+221">
			</div>
			<div class="inBox">
